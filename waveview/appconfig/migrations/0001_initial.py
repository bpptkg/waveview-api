    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.IntegerField(
                        default=0,
                        help_text="Order of the seismicity config in the list.",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "event_types",
                    models.ManyToManyField(blank=True, to="event.eventtype"),
                ),
                (
                    "volcano",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Name of the registered event observer adapter class.",
                        max_length=255,
                    ),
                ),
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Description of the event observer.",
                        null=True,
                    ),
                ),
                (
                    ...
                    models.JSONField(
                        blank=True,
                        default=dict,
                        help_text="Configuration data for the event observer.",
                        null=True,
                    ),
                ),
