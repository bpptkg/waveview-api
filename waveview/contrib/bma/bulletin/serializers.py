...
class BulletinPayloadSerializer(serializers.Serializer):
    ...
    valid = serializers.IntegerField(
        help_text=_("Validation status."), allow_null=True, required=False
    )
    ...
    timestamp = serializers.DateTimeField(
        help_text=_("Last modified date."), allow_null=True, required=False
    )
    timestamp_microsecond = serializers.IntegerField(
        help_text=_("Last modified microseconds."), allow_null=True, required=False
    )
    last_modified = serializers.DateTimeField(
        help_text=_("Last modified date."), allow_null=True, required=False
    )
    last_modified_microsecond = serializers.IntegerField(
        help_text=_("Last modified microseconds."), allow_null=True, required=False
    )
